...
let RefreshJwtStrategy = class RefreshJwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, constanst_1.REFRESH_JWT_KEY) {
    constructor(refreshJwtConfigure, usersService) {
        super({
