...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, constanst_1.JWT_KEY) {
    constructor(jwtConfigure, usersService) {
        super({
